...
function AdminProjectsPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // On an existing project, keep the current thumbnail untouched unless
      // the user actually changed it. This allows legacy/local thumbnail
      // paths to remain valid while the API only validates new thumbnail data.
